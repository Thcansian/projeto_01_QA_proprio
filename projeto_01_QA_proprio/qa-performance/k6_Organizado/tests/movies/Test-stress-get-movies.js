...
export default function () {
    ...
    BaseChecksInst.checkResponseNotEmpty(getMoviesRes);
    BaseChecksInst.checkResponseTime(getMoviesRes, 100);

    const movies = getMoviesRes.json();
    if (movies.length > 20) {
        console.warn(`Warning: More than 20 movies returned in pagination.`);
    }
}
